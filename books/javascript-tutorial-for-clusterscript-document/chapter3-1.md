...
Assets/Chapter3-1に必要なファイルがあります
Chapter3-1シーンを用意しています。シーンを開いてからハンズオンを進めてください。
...
答えは、Assets/Chapter3-1/answers にスクリプトを置きます。

1. 「こんにちは、cluster」というテキストを出力してみましょう
2. 「hello cluster」をコンソールに2回表示してみましょう
